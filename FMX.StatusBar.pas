...
uses
  System.UITypes, FMX.Platform,FMX.Objects,System.Types, FMX.Types, FMX.Forms, FMX.Graphics
{$IFDEF ANDROID} ,
...
type
  TmyUI = record
    StatusBar: Integer;  // Guarda Tamanho do Status Bar
    NavBar   : Integer; // Guarda Tamanho do NavBar
  end;
